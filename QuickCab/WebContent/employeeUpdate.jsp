                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="updateEmployee" method="post">
                                ...
                                <hr>
                                <div class="row mb-3"></div><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;border-color: var(--bs-orange);background: var(--bs-orange);">Register Account</button>
                                <hr>
                            </form>
