...
<head>
    ...
    <title>Dashboard - QuickCab</title>
            ...
            <div id="content" style="background: var(--bs-light);">
                ...
                <div class="container-fluid" style="background: #ffffff;">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4" style="padding-top: 33px;">
                        ...
                        <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="report.jsp" style="color: var(--bs-light);background: var(--bs-blue);border-style: none;border-color: var(--bs-blue);"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report</a>
                   		<%} %>
                    </div>
                      ...
                      <%if (user != null && user.getUserType().equals("employee")){%>
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col" style="padding-bottom: 50px;padding-right: 0px;padding-left: 0px;margin-bottom: -12px;"><a href="vehicleMaintaines.jsp" class="btn btn-primary bounce animated" type="button" style="width: 100px;height: 100px;border-top-left-radius: 50px;border-top-right-radius: 50px;border-style: none;background: var(--bs-blue);"><i class="fa fa-gears" style="margin-right: 13px;margin-left: 15px;"></i>vehicle maintains</a></div>
                                <div class="col" style="padding-bottom: 50px;"></div>
                            </div>
                            <div class="row">
                                <div class="col" style="margin-right: -50px;padding-right: 0px;padding-left: 0px;"><a href="addVehicle.jsp" class="btn btn-primary bounce animated" type="button" style="width: 100px;height: 100px;margin-right: 0px;margin-left: 0px;border-bottom-left-radius: 50px;border-top-left-radius: 50px;border-style: none;background: var(--bs-blue);"><i class="fa fa-plus" style="margin-right: 41px;margin-left: 32px;"></i>add vehicle</a></div>
                                <div class="col" style="border-style: none;"><img class="jello animated" src="assets/img/0.png"  style="width: 100px;margin-left: 35px;border-top-left-radius: 50px;border-top-right-radius: 50px;border-bottom-right-radius: 50px;border-bottom-left-radius: 50px;border: 1px solid var(--bs-red);background-image: url(assets/img/1.png);background-position: center;background-size: cover;"></div>
                                <div class="col" style="padding-right: 0px;"><a href="" class="btn btn-primary bounce animated" type="button" style="width: 100px;height: 100px;margin-right: 0px;margin-left: 0px;border-bottom-right-radius: 50px;border-top-right-radius: 50px;border-style: none;background: var(--bs-blue);"><i class="fa fa-gears" style="margin-right: 13px;margin-left: 15px;"></i></a></div>
                            </div>
                              <div class="row">
                        ...
                        <div class="col">
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col" style="margin-right: -50px;padding-right: 0px;padding-left: 0px;"></div>
                                <div class="col" style="border-style: none;"><img class="jello animated"  style="width: 100px;margin-left: 35px;border-top-left-radius: 50px;border-top-right-radius: 50px;border-bottom-right-radius: 50px;border-bottom-left-radius: 50px;border: 1px solid var(--bs-red);background-image: url(assets/img/0.png);background-position: center;background-size: cover;"></div>
