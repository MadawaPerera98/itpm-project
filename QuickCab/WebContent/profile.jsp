                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                             <form class="user" action="customerProfileUpdate" method="post">
				                                ...
				                                </div><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;background: var(--bs-blue);border-color: var(--bs-blue);">Save details</button>
				                                <hr>
				                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                              <form class="user" action="employeeProfileUpdate" method="post">
				                                ...
				                                </div><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;border-color: var(--bs-blue);background: var(--bs-blue);">Save details</button>
				                                <hr>
				                            </form>
                                        </div>
                                    </div>
