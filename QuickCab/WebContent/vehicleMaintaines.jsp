...
<!DOCTYPE html>
<html style="color: var(--bs-light);border-color: var(--bs-cyan);height: 689px;">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="addMaintain" method="post">
                                ...
                                <hr><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;background: var(--bs-blue);border-color: var(--bs-blue);width: 527px;margin-bottom: 7px;">Submit</button><a href="VehicleMaintainesManegment.jsp" class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;background: var(--bs-blue);border-color: var(--bs-blue);">View Table</a>
                                <hr>
                            </form>
