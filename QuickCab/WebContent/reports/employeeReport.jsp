     ...
     <div id="canvas">
        ...
        <div class="col-md-7">
          <h3 class="text-light mb-2 text-center mt-5 text-danger" style="margin-left: 26px;">TaxiMe</h3>
                <h4 class="text-light mb-1 text-center mt-3  " style="margin-left: 26px;">Employee report</h4>
                <h5 class="-text-secondary mb-4 text-center mt-2  " style="margin-left: 26px;">All Employee</h5>
        </div> 
...
//          data.text
                  ...
                  pdfMake.createPdf(docDefinition).download("AllEmployeeReport-"+today+".pdf");
              }
          });
      }
