		...
		<%
		  ...
		  String id = request.getParameter("id"); 
			  ...
			  if (id.equals("all")){
				  ...
				  vehicleList = vehicleService.getVehicleByStatus(id); 
			  } 
        %>
     ...
     <div id="canvas">
        ...
        <div class="col-md-7">
          <h3 class="text-light mb-2 text-center mt-5 text-danger" style="margin-left: 26px;">TaxiMe</h3>
                ...
                <h5 class="-text-secondary mb-4 text-center mt-2  " style="margin-left: 26px;"><%=id %> vehicle</h5>
        </div> 
                                    ...
                                    %>
                                       ...
                                       <td ><p style="color: var(--bs-danger);"><%=vehicle.getVehicleNumber() %></p></td> 
                                    	...
                                    	for(Vehicle vehicle : list){ 
                                    		if(vehicle.getStatus().equals("Assinged")) {
                                    			assigned++;
                                    		}if(vehicle.getStatus().equals("not-assigned")) {
                                    			notAssigned++;
                                    		}  
                                    	}
                                    	total =  notAssigned+assigned;
                                        %>
                                        <tr > 
                                            <th>Total Assinged  vehicles : <%=assigned %></th>
                                            <th>Total not Assigned vehicles : <%=notAssigned %></th>   
                                            <th> </th> 
                                            
                                        </tr>
                                         <tr >
                                            <th>Total vehicles in system : <%=total %></th>  
                                        </tr>
                                    </thead>
                                    </tbody>
                                    <tfoot>
