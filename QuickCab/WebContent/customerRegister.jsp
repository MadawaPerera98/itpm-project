...
<body class="bg-gradient-primary" style="border-color: var(--bs-orange);background: var(--bs-cyan);">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="registerCustomer" method="post">
                                ...
                                </div><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;background: var(--bs-blue);border-color: var(--bs-blue);">Register Account</button>
                                <hr>
                            </form>
